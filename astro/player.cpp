...
Player::Player(game* game_)
{
    ...
    jump_effect.setSource(QUrl::fromLocalFile("../sound/jump.wav"));
    jump_effect.setVolume(0.25);
    dash_effect.setSource(QUrl::fromLocalFile("../sound/dash.wav"));
    dash_effect.setVolume(1);
